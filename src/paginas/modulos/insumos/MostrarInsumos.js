                ...
                <section className="content px-2 px-sm-3">
                    <div className="card">
                        ...
                        <div className="card-body">
                            {/* table-responsive encapsula la tabla para celulares evitando desbordamientos */}
                                ...
                                <table className="table table-bordered table-striped table-hover align-middle">
                                    <thead className="table-success">
                                        <tr>
                                            ...
                                            {/* Espacio del 22% para permitir la separación extrema horizontal de botones */}
                                            ...
                                            <tr key={index}>
                                                ...
                                                <td className="text-center" style={{ verticalAlign: 'middle' }}>
                                                    {/* 
                                                      ...
                                                      - Móviles: Apilados verticalmente sin colapsar (gap-2)
                                                      - PC/Tablets: Distribución horizontal con separación limpia (gap-sm-5)
                                                    */}
